...
- Gateway 状态：mode、sendEnabled、running、serviceEnabled、checkpointState、checkpointHealthy、checkpointBusy、manualReplyProbeReady、manualReplyProbeDegraded、manualReplyProbeErrorCode、modeConsistent、ready；
