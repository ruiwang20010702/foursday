...
The current source candidate is `v0.9.0-rc.2`; the latest GitHub Release remains `v0.8.0-rc.1`. Source validation, a GitHub release, technical deployment and production activation are separate states. The detailed product contract lives in the [PRD](../产品需求文档.md).
