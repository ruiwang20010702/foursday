    ...
    def from_environment(cls) -> "JsonLineDwsBridge":
        ...
        allowed = {
            ...
            if key in {
                ...
                "FOURSDAY_WORK_CONTEXT_FILE", "FOURSDAY_TASK_LEDGER_FILE",
                "FOURSDAY_NODE_PATH", "FOURSDAY_CODEX_PATH", "CODEX_HOME",
                "FOURSDAY_PROJECT_REGISTRY", "FOURSDAY_FALLBACK_WORKSPACE",
                "FOURSDAY_CODEX_PROJECT_STATE_FILE", "DWS_PERSONAL_PROJECT_SYNC_ENABLED",
