...
<title>Foursday 工作现场</title><style nonce="NONCE">
...
function taskTitle(task){return task.taskContract?.title||task.projectId||'尚未生成任务合同'}
